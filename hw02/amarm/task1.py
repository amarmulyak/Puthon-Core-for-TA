...
'''
# Find the number of word convergence in Python Philosophy
...
print(f'''Python philosophy contains:
{count_better} word(s) "better"
{count_never} word(s) "never"
{count_is} word(s) "is"
''')
...
# Replace "i" to "&" in Python Philosophy
