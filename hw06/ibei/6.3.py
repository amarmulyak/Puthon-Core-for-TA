...
num - input number.NOTE: Assume that the "zero" digit also belongs to even numbers
EXAMPLE OF Inputs/Ouputs when using this function:print parse_number(34567) {'odd': 3, 'even': 2}
print parse_number(100) {'odd': 1, 'even': 2} print parse_number("word") False
"""
